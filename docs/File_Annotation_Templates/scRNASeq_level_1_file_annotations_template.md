...
permalink: docs/scRNASeq_level_1_file_annotations_template.html
title: Sc Rnaseq Level 1 File Annotations Template
---

{% assign mydata=site.data.File_Annotation_Templates.scRNASeq_level_1_file_annotations_template %} 
{: .note-title } 
>Sc Rnaseq Level 1 File Annotations Template
>
>A template for collecting file-level metadata for scRNA-seq fastq files (i.e., level 1 data). [[Source]](nan)
