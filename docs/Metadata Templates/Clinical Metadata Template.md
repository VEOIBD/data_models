...
<script type="text/javascript">
  var pages = ['site','participantRole','siblingType','sex','ageAtDiagnosisUnit','GIPhenotype','diseaseActivityLocation','upperDiseaseType','diseaseActivityBehavior','birthCountry','race','ethnicity'];
  $('#myTable').DataTable({
    responsive: {
        details: {
